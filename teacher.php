...
<div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card shadow-lg" style="width: 100%; max-width: 400px;">
        <div class="card-body">
            ...
            <form id="frmLoginTeacher">
                <div class="mb-3">
                    <label for="teacher_code" class="form-label">Teacher Code</label>
                    <div class="input-group">
                        <span class="input-group-text"><i class="bi bi-person"></i></span>
                        <input type="text" class="form-control" id="teacher_code" name="teacher_code" required placeholder="Enter your teacher code">
                    </div>
                </div>
                <div class="mb-3">
                ...
                <button type="submit" id="btnLoginTeacher" class="btn btn-success w-100">Login</button>
            </form>
        </div>
    </div>
</div>
